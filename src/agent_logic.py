...
def generate_test_code(source_code: str):
    ...
    prompt = (
        ...
        "5. Do NOT wrap your response in markdown code blocks like ```python. Just return raw text code.\n\n"
        f"CODE TO TEST:\n{source_code}"
    )
...
def refine_test_code(source_code: str, failed_test_code: str, error_log: str):
    ...
    prompt = (
        ...
        "3. Do NOT use markdown blocks like ```python. Return ONLY the raw, corrected python test functions.\n"
    )
